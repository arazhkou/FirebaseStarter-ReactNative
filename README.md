...
```
git clone https://github.com/arazhkou/FirebaseStarter-ReactNative.git NewApp
cd NewApp
```
...
Enter the **Explicit App ID** of the app, in this case, *me.arapp.newapp*.
...
##License
[MIT License](https://github.com/arazhkou/FirebaseStarter-ReactNative/blob/master/LICENSE). Do whatever you want to do.
